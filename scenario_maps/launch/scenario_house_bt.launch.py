...
def generate_launch_description():
    ...
    param_file = os.path.join(scenario_maps_dir, 'config', 'bombs_config_house.yaml')
    rviz_file = os.path.join(scenario_maps_dir, 'config', 'config_house.rviz')
